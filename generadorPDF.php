...
<head>
    ...
    <title>Generador de proyectos con IA</title>
    <style>
...
<body>
    <div class="chat-container">
        <h1>Generador de proyectos con IA</h1>
    ...
    <script>
        ...
        function sendMessage() {
            ...
            fetch('generadorProjectsPDF.php', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                ...
                if (data.debug_output) {
                    console.warn("DEBUG OUTPUT from generadorProjectsPDF.php:", data.debug_output);
                }
            })
            .catch(error => {
                // Eliminar el mensaje de carga
